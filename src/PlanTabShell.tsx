    ...
    <div className="sticky top-0 z-10 bg-white/80 backdrop-blur border-b" style={{ borderColor: COLORS.lightGray }}>
      <div className="px-4 py-3 flex items-center">
        ...
        <div className="absolute right-4 top-3 flex items-center gap-2">
          ...
          <button className="p-2 rounded-lg" aria-label="Settings"><Icon.Settings/></button>
        </div>
      </div>
    </div>
  );
...
function BottomNav({ value, onChange }:{ value:TabKey; onChange:(k:TabKey)=>void }){
  return (
    <nav className="fixed bottom-0 inset-x-0 bg-white/95 backdrop-blur border-t" style={{ borderColor: COLORS.lightGray }}>
...
export default function PlanTabShell() {
  ...
  return (
    <div className="min-h-[100dvh] pb-16" style={{ background: COLORS.background }}>
