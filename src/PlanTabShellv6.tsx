...
{profileOpen && (
  <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40">
    <div
      className="w-full max-w-lg bg-white rounded-2xl shadow-lg border p-3 relative"
      style={{ borderColor: COLORS.lightGray }}
    >
  ...
  {/* Extra close button under the Clerk widget */}
  <div className="mt-4 flex justify-end">
    <button
      className="h-10 px-4 rounded-xl text-sm font-medium"
      style={{ border: `1px solid ${COLORS.lightGray}`, color: COLORS.charcoal }}
      onClick={() => setProfileOpen(false)}
    >
      Close
    </button>
